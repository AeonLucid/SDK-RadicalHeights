...
public:
	...
	TEnumAsByte<ESlateVisibility>                      Visibility;                                               // 0x0090(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
public:
	...
	bool                                               bCanTick;                                                 // 0x018A(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bCanTickBlueprint;                                        // 0x018B(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bCanPaint;                                                // 0x018C(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	unsigned char                                      UnknownData04[0x58];                                      // 0x01E0(0x0058) MISSED OFFSET
...
{
public:
	TEnumAsByte<EWidgetSpace>                          Space;                                                    // 0x0700(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x7];                                       // 0x0701(0x0007) MISSED OFFSET
	class UClass*                                      WidgetClass;                                              // 0x0708(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	struct FIntPoint                                   DrawSize;                                                 // 0x0710(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bManuallyRedraw;                                          // 0x0718(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bRedrawRequested;                                         // 0x0719(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x2];                                       // 0x071A(0x0002) MISSED OFFSET
	float                                              RedrawTime;                                               // 0x071C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              LastWidgetRenderTime;                                     // 0x0720(0x0004) (ZeroConstructor, IsPlainOldData)
	bool                                               bWindowFocusable;                                         // 0x0724(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x3];                                       // 0x0725(0x0003) MISSED OFFSET
	struct FIntPoint                                   CurrentDrawSize;                                          // 0x0728(0x0008) (ZeroConstructor, IsPlainOldData)
	bool                                               bDrawAtDesiredSize;                                       // 0x0730(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x3];                                       // 0x0731(0x0003) MISSED OFFSET
	struct FVector2D                                   Pivot;                                                    // 0x0734(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x4];                                       // 0x073C(0x0004) MISSED OFFSET
	class ULocalPlayer*                                OwnerPlayer;                                              // 0x0740(0x0008) (ZeroConstructor, IsPlainOldData)
	struct FLinearColor                                BackgroundColor;                                          // 0x0748(0x0010) (Edit, ZeroConstructor, IsPlainOldData)
	struct FLinearColor                                TintColorAndOpacity;                                      // 0x0758(0x0010) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              OpacityFromTexture;                                       // 0x0768(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<EWidgetBlendMode>                      BlendMode;                                                // 0x076C(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bIsOpaque;                                                // 0x076D(0x0001) (ZeroConstructor, Deprecated, IsPlainOldData)
	bool                                               bIsTwoSided;                                              // 0x076E(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData05[0x1];                                       // 0x076F(0x0001) MISSED OFFSET
	float                                              ParabolaDistortion;                                       // 0x0770(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               TickWhenOffscreen;                                        // 0x0774(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData06[0x3];                                       // 0x0775(0x0003) MISSED OFFSET
	class UUserWidget*                                 Widget;                                                   // 0x0778(0x0008) (ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData)
	unsigned char                                      UnknownData07[0x20];                                      // 0x0780(0x0020) MISSED OFFSET
	class UBodySetup*                                  BodySetup;                                                // 0x07A0(0x0008) (ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData)
	class UMaterialInterface*                          TranslucentMaterial;                                      // 0x07A8(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	class UMaterialInterface*                          TranslucentMaterial_OneSided;                             // 0x07B0(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	class UMaterialInterface*                          OpaqueMaterial;                                           // 0x07B8(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	class UMaterialInterface*                          OpaqueMaterial_OneSided;                                  // 0x07C0(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	class UMaterialInterface*                          MaskedMaterial;                                           // 0x07C8(0x0008) (ZeroConstructor, IsPlainOldData)
	class UMaterialInterface*                          MaskedMaterial_OneSided;                                  // 0x07D0(0x0008) (ZeroConstructor, IsPlainOldData)
	class UTextureRenderTarget2D*                      RenderTarget;                                             // 0x07D8(0x0008) (ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData)
	class UMaterialInstanceDynamic*                    MaterialInstance;                                         // 0x07E0(0x0008) (ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData)
	bool                                               bUseLegacyRotation;                                       // 0x07E8(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bAddedToScreen;                                           // 0x07E9(0x0001) (ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData)
	bool                                               bEditTimeUsable;                                          // 0x07EA(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData08[0x5];                                       // 0x07EB(0x0005) MISSED OFFSET
	struct FName                                       SharedLayerName;                                          // 0x07F0(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                LayerZOrder;                                              // 0x07F8(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData09[0x3C];                                      // 0x07FC(0x003C) MISSED OFFSET
	float                                              UpdateDeltaTime;                                          // 0x0838(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              OversampleFactor;                                         // 0x083C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               IsDirty;                                                  // 0x0840(0x0001) (ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      UnknownData10[0x3];                                       // 0x0841(0x0003) MISSED OFFSET
	float                                              AccumulatedTickTime;                                      // 0x0844(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      UnknownData11[0x8];                                       // 0x0848(0x0008) MISSED OFFSET
...
public:
	...
	struct FSlateBrush                                 Brush;                                                    // 0x0120(0x0090) (Edit, BlueprintVisible)
	...
	struct FScriptDelegate                             OnMouseWheelEvent;                                        // 0x01F0(0x0014) (Edit, ZeroConstructor, InstancedReference)
...
public:
	...
	bool                                               bForceLinearGamma;                                        // 0x0140(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x7];                                       // 0x0141(0x0007) MISSED OFFSET
	struct FName                                       TextureParameter;                                         // 0x0148(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
...
{
public:
	TArray<struct FName>                               BrushPropertyNamePath;                                    // 0x0038(0x0010) (ZeroConstructor)
	struct FName                                       TrackName;                                                // 0x0048(0x0008) (ZeroConstructor, IsPlainOldData)
...
public:
	...
	unsigned char                                      UnknownData01[0x1F];                                      // 0x01C1(0x001F) MISSED OFFSET
...
{
public:
	TArray<class FString>                              DefaultOptions;                                           // 0x0118(0x0010) (Edit, ZeroConstructor)
	class FString                                      SelectedOption;                                           // 0x0128(0x0010) (Edit, ZeroConstructor)
	unsigned char                                      UnknownData00[0x8];                                       // 0x0138(0x0008) MISSED OFFSET
	struct FComboBoxStyle                              WidgetStyle;                                              // 0x0140(0x0440) (Edit, BlueprintVisible)
	struct FTableRowStyle                              ItemStyle;                                                // 0x0580(0x0720) (Edit, BlueprintVisible)
	...
	struct FSlateFontInfo                              Font;                                                     // 0x0CB8(0x0040) (Edit, BlueprintVisible, BlueprintReadOnly)
	...
	unsigned char                                      UnknownData02[0x40];                                      // 0x0D50(0x0040) MISSED OFFSET
...
public:
	...
	TEnumAsByte<ETextWrappingPolicy>                   WrappingPolicy;                                           // 0x0128(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
...
public:
	...
	struct FEditableTextStyle                          WidgetStyle;                                              // 0x0170(0x0220) (Edit, BlueprintVisible)
	class USlateWidgetStyleAsset*                      Style;                                                    // 0x0390(0x0008) (ZeroConstructor, Deprecated, IsPlainOldData)
	class USlateBrushAsset*                            BackgroundImageSelected;                                  // 0x0398(0x0008) (ZeroConstructor, Deprecated, IsPlainOldData)
	class USlateBrushAsset*                            BackgroundImageComposing;                                 // 0x03A0(0x0008) (ZeroConstructor, Deprecated, IsPlainOldData)
	class USlateBrushAsset*                            CaretImage;                                               // 0x03A8(0x0008) (ZeroConstructor, Deprecated, IsPlainOldData)
	struct FSlateFontInfo                              Font;                                                     // 0x03B0(0x0040) (Deprecated)
	...
	struct FShapedTextOptions                          ShapedTextOptions;                                        // 0x0428(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly)
...
// 0x0988 (0x0AA0 - 0x0118)
class UEditableTextBox : public UWidget
{
public:
	struct FText                                       Text;                                                     // 0x0118(0x0018) (Edit)
	struct FScriptDelegate                             TextDelegate;                                             // 0x0130(0x0014) (ZeroConstructor, InstancedReference)
	struct FEditableTextBoxStyle                       WidgetStyle;                                              // 0x0140(0x0860) (Edit, BlueprintVisible)
	class USlateWidgetStyleAsset*                      Style;                                                    // 0x09A0(0x0008) (ZeroConstructor, Deprecated, IsPlainOldData)
	struct FText                                       HintText;                                                 // 0x09A8(0x0018) (Edit, BlueprintVisible, BlueprintReadOnly)
	struct FScriptDelegate                             HintTextDelegate;                                         // 0x09C0(0x0014) (ZeroConstructor, InstancedReference)
	struct FSlateFontInfo                              Font;                                                     // 0x09D0(0x0040) (Deprecated)
	struct FLinearColor                                ForegroundColor;                                          // 0x0A10(0x0010) (ZeroConstructor, Deprecated, IsPlainOldData)
	struct FLinearColor                                BackgroundColor;                                          // 0x0A20(0x0010) (ZeroConstructor, Deprecated, IsPlainOldData)
	struct FLinearColor                                ReadOnlyForegroundColor;                                  // 0x0A30(0x0010) (ZeroConstructor, Deprecated, IsPlainOldData)
	bool                                               IsReadOnly;                                               // 0x0A40(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               IsPassword;                                               // 0x0A41(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x2];                                       // 0x0A42(0x0002) MISSED OFFSET
	float                                              MinimumDesiredWidth;                                      // 0x0A44(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	struct FMargin                                     Padding;                                                  // 0x0A48(0x0010) (Deprecated)
	bool                                               IsCaretMovedWhenGainFocus;                                // 0x0A58(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               SelectAllTextWhenFocused;                                 // 0x0A59(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               RevertTextOnEscape;                                       // 0x0A5A(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               ClearKeyboardFocusOnCommit;                               // 0x0A5B(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               SelectAllTextOnCommit;                                    // 0x0A5C(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               AllowContextMenu;                                         // 0x0A5D(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<EVirtualKeyboardType>                  KeyboardType;                                             // 0x0A5E(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x1];                                       // 0x0A5F(0x0001) MISSED OFFSET
	struct FShapedTextOptions                          ShapedTextOptions;                                        // 0x0A60(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly)
	struct FScriptMulticastDelegate                    OnTextChanged;                                            // 0x0A68(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnTextCommitted;                                          // 0x0A78(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData02[0x18];                                      // 0x0A88(0x0018) MISSED OFFSET
...
public:
	unsigned char                                      UnknownData00[0x8];                                       // 0x0118(0x0008) MISSED OFFSET
	struct FExpandableAreaStyle                        Style;                                                    // 0x0120(0x0130) (Edit, BlueprintVisible, BlueprintReadOnly)
	...
	class UWidget*                                     HeaderContent;                                            // 0x0340(0x0008) (ZeroConstructor, IsPlainOldData)
	class UWidget*                                     BodyContent;                                              // 0x0348(0x0008) (ZeroConstructor, IsPlainOldData)
...
public:
	...
	struct FSlateFontInfo                              Font;                                                     // 0x0138(0x0040) (Edit, BlueprintVisible, BlueprintReadOnly)
	struct FMargin                                     Margin;                                                   // 0x0178(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly)
	struct FLinearColor                                ColorAndOpacity;                                          // 0x0188(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	struct FText                                       KeySelectionText;                                         // 0x0198(0x0018) (Edit, BlueprintVisible, BlueprintReadOnly)
	bool                                               bAllowModifierKeys;                                       // 0x01B0(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x7];                                       // 0x01B1(0x0007) MISSED OFFSET
	struct FScriptMulticastDelegate                    OnKeySelected;                                            // 0x01B8(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnIsSelectingKeyChanged;                                  // 0x01C8(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
...
public:
	...
	unsigned char                                      UnknownData00[0xE];                                       // 0x0162(0x000E) MISSED OFFSET
	struct FSlateBrush                                 Background;                                               // 0x0170(0x0090) (Edit, BlueprintVisible, BlueprintReadOnly)
	struct FScriptDelegate                             BackgroundDelegate;                                       // 0x0200(0x0014) (ZeroConstructor, InstancedReference)
	struct FLinearColor                                BrushColor;                                               // 0x0210(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	struct FScriptDelegate                             BrushColorDelegate;                                       // 0x0220(0x0014) (ZeroConstructor, InstancedReference)
	struct FVector2D                                   DesiredSizeScale;                                         // 0x0230(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               bShowEffectWhenDisabled;                                  // 0x0238(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	...
	struct FScriptDelegate                             OnMouseButtonUpEvent;                                     // 0x0250(0x0014) (Edit, ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnMouseMoveEvent;                                         // 0x0260(0x0014) (Edit, ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnMouseDoubleClickEvent;                                  // 0x0270(0x0014) (Edit, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData02[0x10];                                      // 0x0280(0x0010) MISSED OFFSET
	class USlateBrushAsset*                            Brush;                                                    // 0x0290(0x0008) (ZeroConstructor, Deprecated, IsPlainOldData)
...
public:
	...
	unsigned char                                      UnknownData00[0x8];                                       // 0x0138(0x0008) MISSED OFFSET
	struct FButtonStyle                                WidgetStyle;                                              // 0x0140(0x02B0) (Edit, BlueprintVisible)
	...
	bool                                               DisplayFocusAsHovered;                                    // 0x0413(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
...
public:
	...
	struct FCheckBoxStyle                              WidgetStyle;                                              // 0x0150(0x05E0) (Edit, BlueprintVisible)
	class USlateWidgetStyleAsset*                      Style;                                                    // 0x0730(0x0008) (ZeroConstructor, Deprecated, IsPlainOldData)
	class USlateBrushAsset*                            UncheckedImage;                                           // 0x0738(0x0008) (ZeroConstructor, Deprecated, IsPlainOldData)
	class USlateBrushAsset*                            UncheckedHoveredImage;                                    // 0x0740(0x0008) (ZeroConstructor, Deprecated, IsPlainOldData)
	class USlateBrushAsset*                            UncheckedPressedImage;                                    // 0x0748(0x0008) (ZeroConstructor, Deprecated, IsPlainOldData)
	class USlateBrushAsset*                            CheckedImage;                                             // 0x0750(0x0008) (ZeroConstructor, Deprecated, IsPlainOldData)
	class USlateBrushAsset*                            CheckedHoveredImage;                                      // 0x0758(0x0008) (ZeroConstructor, Deprecated, IsPlainOldData)
	class USlateBrushAsset*                            CheckedPressedImage;                                      // 0x0760(0x0008) (ZeroConstructor, Deprecated, IsPlainOldData)
	class USlateBrushAsset*                            UndeterminedImage;                                        // 0x0768(0x0008) (ZeroConstructor, Deprecated, IsPlainOldData)
	class USlateBrushAsset*                            UndeterminedHoveredImage;                                 // 0x0770(0x0008) (ZeroConstructor, Deprecated, IsPlainOldData)
	class USlateBrushAsset*                            UndeterminedPressedImage;                                 // 0x0778(0x0008) (ZeroConstructor, Deprecated, IsPlainOldData)
	TEnumAsByte<EHorizontalAlignment>                  HorizontalAlignment;                                      // 0x0780(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x3];                                       // 0x0781(0x0003) MISSED OFFSET
	struct FMargin                                     Padding;                                                  // 0x0784(0x0010) (Deprecated)
	unsigned char                                      UnknownData03[0x4];                                       // 0x0794(0x0004) MISSED OFFSET
	struct FSlateColor                                 BorderBackgroundColor;                                    // 0x0798(0x0028) (Deprecated)
	bool                                               IsFocusable;                                              // 0x07C0(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x7];                                       // 0x07C1(0x0007) MISSED OFFSET
	struct FScriptMulticastDelegate                    OnCheckStateChanged;                                      // 0x07C8(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData05[0x18];                                      // 0x07D8(0x0018) MISSED OFFSET
...
{
public:
	struct FScrollBoxStyle                             WidgetStyle;                                              // 0x0130(0x0250) (Edit, BlueprintVisible)
	struct FScrollBarStyle                             WidgetBarStyle;                                           // 0x0380(0x0520) (Edit, BlueprintVisible)
	...
	TEnumAsByte<ESlateVisibility>                      ScrollBarVisibility;                                      // 0x08B1(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<EConsumeMouseWheel>                    ConsumeMouseWheel;                                        // 0x08B2(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	...
	float                                              PingPongAutoScrollSpeed;                                  // 0x08C0(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	float                                              PingPongSwitchPauseTime;                                  // 0x08C4(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
...
public:
	...
	struct FScriptDelegate                             ActiveWidgetIndexDelegate;                                // 0x0138(0x0014) (ZeroConstructor, InstancedReference)
...
public:
	unsigned char                                      UnknownData00[0x8];                                       // 0x0118(0x0008) MISSED OFFSET
	struct FProgressBarStyle                           WidgetStyle;                                              // 0x0120(0x01C0) (Edit, BlueprintVisible)
	...
	struct FLinearColor                                FillColorAndOpacity;                                      // 0x0318(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
...
// Class UMG.Scrollbar
// 0x0558 (0x0670 - 0x0118)
class UScrollbar : public UWidget
{
public:
	unsigned char                                      UnknownData00[0x8];                                       // 0x0118(0x0008) MISSED OFFSET
	struct FScrollBarStyle                             WidgetStyle;                                              // 0x0120(0x0520) (Edit, BlueprintVisible)
	...
	unsigned char                                      UnknownData01[0x2];                                       // 0x064A(0x0002) MISSED OFFSET
	struct FVector2D                                   Thickness;                                                // 0x064C(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x1C];                                      // 0x0654(0x001C) MISSED OFFSET
...
public:
	...
	struct FSliderStyle                                WidgetStyle;                                              // 0x0130(0x0260) (Edit, BlueprintVisible)
	...
	struct FLinearColor                                SliderBarColor;                                           // 0x0394(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	struct FLinearColor                                SliderHandleColor;                                        // 0x03A4(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
...
public:
	...
	unsigned char                                      UnknownData00[0x4];                                       // 0x011C(0x0004) MISSED OFFSET
	struct FScriptDelegate                             ValueDelegate;                                            // 0x0120(0x0014) (ZeroConstructor, InstancedReference)
	struct FSpinBoxStyle                               WidgetStyle;                                              // 0x0130(0x0320) (Edit, BlueprintVisible)
	...
	struct FSlateFontInfo                              Font;                                                     // 0x0460(0x0040) (Edit, BlueprintVisible, BlueprintReadOnly)
	float                                              MinDesiredWidth;                                          // 0x04A0(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               ClearKeyboardFocusOnCommit;                               // 0x04A4(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               SelectAllTextOnCommit;                                    // 0x04A5(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x2];                                       // 0x04A6(0x0002) MISSED OFFSET
	struct FSlateColor                                 ForegroundColor;                                          // 0x04A8(0x0028) (Edit, BlueprintVisible, BlueprintReadOnly)
	struct FScriptMulticastDelegate                    OnValueChanged;                                           // 0x04D0(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnValueCommitted;                                         // 0x04E0(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnBeginSliderMovement;                                    // 0x04F0(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnEndSliderMovement;                                      // 0x0500(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      bOverride_MinValue : 1;                                   // 0x0510(0x0001) (Edit)
	unsigned char                                      bOverride_MaxValue : 1;                                   // 0x0510(0x0001) (Edit)
	unsigned char                                      bOverride_MinSliderValue : 1;                             // 0x0510(0x0001) (Edit)
	unsigned char                                      bOverride_MaxSliderValue : 1;                             // 0x0510(0x0001) (Edit)
	unsigned char                                      UnknownData02[0x3];                                       // 0x0511(0x0003) MISSED OFFSET
	float                                              MinValue;                                                 // 0x0514(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              MaxValue;                                                 // 0x0518(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              MinSliderValue;                                           // 0x051C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              MaxSliderValue;                                           // 0x0520(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x1C];                                      // 0x0524(0x001C) MISSED OFFSET
...
public:
	...
	struct FTextBlockStyle                             TextStyle;                                                // 0x09E0(0x0150) (Edit, BlueprintVisible)
	bool                                               AllowContextMenu;                                         // 0x0B30(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	...
	unsigned char                                      UnknownData01[0x10];                                      // 0x0BD0(0x0010) MISSED OFFSET
...
public:
	...
	unsigned char                                      UnknownData00[0x168];                                     // 0x01C8(0x0168) MISSED OFFSET
...
public:
	...
	struct FScriptDelegate                             ShadowColorAndOpacityDelegate;                            // 0x01F8(0x0014) (ZeroConstructor, InstancedReference)
...
class UWebWidget : public UWidget
{
public:
	class FString                                      URL;                                                      // 0x0118(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance)
	unsigned char                                      UnknownData00[0x10];                                      // 0x0128(0x0010) MISSED OFFSET

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("Class UMG.WebWidget");
		return ptr;
	}
...
public:
	...
	float                                              InteractionDistance;                                      // 0x0270(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<EWidgetInteractionSource>              InteractionSource;                                        // 0x0274(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bEnableHitTesting;                                        // 0x0275(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bShowDebug;                                               // 0x0276(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x1];                                       // 0x0277(0x0001) MISSED OFFSET
	struct FLinearColor                                DebugColor;                                               // 0x0278(0x0010) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	struct FVector2D                                   LocalHitLocation;                                         // 0x0388(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
	struct FVector2D                                   LastLocalHitLocation;                                     // 0x0390(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
	class UWidgetComponent*                            HoveredWidgetComponent;                                   // 0x0398(0x0008) (ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData)
	...
	unsigned char                                      UnknownData03[0x5];                                       // 0x042B(0x0005) MISSED OFFSET
