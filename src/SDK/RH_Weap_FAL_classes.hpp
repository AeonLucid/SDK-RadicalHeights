...
#include "RH_Weap_FAL_structs.hpp"
...
// DynamicClass Weap_FAL.Weap_FAL_C
// 0x0040 (0x1000 - 0x0FC0)
class AWeap_FAL_C : public AShooterWeapon
{
public:
	...
	{
		static auto ptr = UObject::FindClass("DynamicClass Weap_FAL.Weap_FAL_C");
		return ptr;
	}
