...
#include "RH_Niagara_structs.hpp"
...
{
public:
	class UNiagaraComponent*                           NiagaraComponent;                                         // 0x0398(0x0008) (Edit, ExportObject, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData)
...
{
public:
	class UNiagaraEffect*                              Asset;                                                    // 0x05E0(0x0008) (ZeroConstructor, IsPlainOldData)
