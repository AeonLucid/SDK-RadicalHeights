...
#include "RH_WeaponPickup_python_structs.hpp"
...
// DynamicClass WeaponPickup_python.WeaponPickup_python_C
// 0x0010 (0x0450 - 0x0440)
class AWeaponPickup_python_C : public AShooterWeaponPickup
{
public:
	...
	{
		static auto ptr = UObject::FindClass("DynamicClass WeaponPickup_python.WeaponPickup_python_C");
		return ptr;
	}
