...
#include "RH_Weap_HiPower_structs.hpp"
...
// DynamicClass Weap_HiPower.Weap_HiPower_C
// 0x0040 (0x0FD0 - 0x0F90)
class AWeap_HiPower_C : public AShooterWeapon
{
public:
	...
	{
		static auto ptr = UObject::FindClass("DynamicClass Weap_HiPower.Weap_HiPower_C");
		return ptr;
	}
