...
#include "RH_PrizePickup_Vacation_Cleveland_structs.hpp"
...
// DynamicClass PrizePickup_Vacation_Cleveland.PrizePickup_Vacation_Cleveland_C
// 0x0028 (0x0410 - 0x03E8)
class APrizePickup_Vacation_Cleveland_C : public AShooterPickup_Cash
{
public:
	...
	{
		static auto ptr = UObject::FindClass("DynamicClass PrizePickup_Vacation_Cleveland.PrizePickup_Vacation_Cleveland_C");
		return ptr;
	}
