...
#include "RH_Weap_SmokeBomb_structs.hpp"
...
// DynamicClass Weap_SmokeBomb.Weap_SmokeBomb_C
// 0x0040 (0x0FD0 - 0x0F90)
class AWeap_SmokeBomb_C : public AShooterWeapon
{
public:
	...
	{
		static auto ptr = UObject::FindClass("DynamicClass Weap_SmokeBomb.Weap_SmokeBomb_C");
		return ptr;
	}
