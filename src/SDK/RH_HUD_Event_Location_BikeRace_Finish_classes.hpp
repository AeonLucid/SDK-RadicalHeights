...
#include "RH_HUD_Event_Location_BikeRace_Finish_structs.hpp"
...
// DynamicClass HUD_Event_Location_BikeRace_Finish.HUD_Event_Location_BikeRace_Finish_C
// 0x0028 (0x0270 - 0x0248)
class UHUD_Event_Location_BikeRace_Finish_C : public UShooterUserWidget
{
public:
	...
	{
		static auto ptr = UObject::FindClass("DynamicClass HUD_Event_Location_BikeRace_Finish.HUD_Event_Location_BikeRace_Finish_C");
		return ptr;
	}
