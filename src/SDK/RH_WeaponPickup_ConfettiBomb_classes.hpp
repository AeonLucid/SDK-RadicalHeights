...
#include "RH_WeaponPickup_ConfettiBomb_structs.hpp"
...
// DynamicClass WeaponPickup_ConfettiBomb.WeaponPickup_ConfettiBomb_C
// 0x0010 (0x0448 - 0x0438)
class AWeaponPickup_ConfettiBomb_C : public AShooterWeaponPickup
{
public:
	...
	{
		static auto ptr = UObject::FindClass("DynamicClass WeaponPickup_ConfettiBomb.WeaponPickup_ConfettiBomb_C");
		return ptr;
	}
