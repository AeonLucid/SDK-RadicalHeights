...
#include "RH_Foliage_structs.hpp"
...
{
public:
	struct FScriptMulticastDelegate                    OnInstanceTakePointDamage;                                // 0x0940(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnInstanceTakeRadialDamage;                               // 0x0950(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
...
public:
	...
	struct FVector                                     TouchingActorEntryPosition;                               // 0x03B0(0x000C) (ZeroConstructor, Transient, IsPlainOldData)
	struct FVector                                     FoliageVelocity;                                          // 0x03BC(0x000C) (ZeroConstructor, Transient, IsPlainOldData)
	struct FVector                                     FoliageForce;                                             // 0x03C8(0x000C) (ZeroConstructor, Transient, IsPlainOldData)
	struct FVector                                     FoliagePosition;                                          // 0x03D4(0x000C) (ZeroConstructor, Transient, IsPlainOldData)
