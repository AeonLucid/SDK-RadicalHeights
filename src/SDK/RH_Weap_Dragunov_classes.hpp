...
#include "RH_Weap_Dragunov_structs.hpp"
...
// DynamicClass Weap_Dragunov.Weap_Dragunov_C
// 0x0040 (0x1000 - 0x0FC0)
class AWeap_Dragunov_C : public AShooterWeapon
{
public:
	...
	{
		static auto ptr = UObject::FindClass("DynamicClass Weap_Dragunov.Weap_Dragunov_C");
		return ptr;
	}
