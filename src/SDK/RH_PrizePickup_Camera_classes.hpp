...
#include "RH_PrizePickup_Camera_structs.hpp"
...
// DynamicClass PrizePickup_Camera.PrizePickup_Camera_C
// 0x0028 (0x0408 - 0x03E0)
class APrizePickup_Camera_C : public AShooterPickup_Cash
{
public:
	...
	{
		static auto ptr = UObject::FindClass("DynamicClass PrizePickup_Camera.PrizePickup_Camera_C");
		return ptr;
	}
