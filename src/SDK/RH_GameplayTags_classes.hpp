...
#include "RH_GameplayTags_structs.hpp"
...
public:
	...
	TArray<class UDataTable*>                          GameplayTagTables;                                        // 0x0150(0x0010) (ZeroConstructor)
	unsigned char                                      UnknownData01[0xC0];                                      // 0x0160(0x00C0) MISSED OFFSET
...
public:
	...
	TArray<class FString>                              CommonlyReplicatedTags;                                   // 0x0038(0x0010) (Edit, ZeroConstructor, Config)
	int                                                NetIndexFirstBitSegment;                                  // 0x0048(0x0004) (Edit, ZeroConstructor, Config, IsPlainOldData)
