...
#include "RH_Consumable_MedKit_structs.hpp"
...
// DynamicClass Consumable_MedKit.Consumable_Medkit_C
// 0x0040 (0x0FD0 - 0x0F90)
class AConsumable_Medkit_C : public AShooterWeapon
{
public:
	...
	{
		static auto ptr = UObject::FindClass("DynamicClass Consumable_MedKit.Consumable_Medkit_C");
		return ptr;
	}
