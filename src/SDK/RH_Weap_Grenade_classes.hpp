...
#include "RH_Weap_Grenade_structs.hpp"
...
// DynamicClass Weap_Grenade.Weap_Grenade_C
// 0x0040 (0x0FD0 - 0x0F90)
class AWeap_Grenade_C : public AShooterWeapon
{
public:
	...
	{
		static auto ptr = UObject::FindClass("DynamicClass Weap_Grenade.Weap_Grenade_C");
		return ptr;
	}
