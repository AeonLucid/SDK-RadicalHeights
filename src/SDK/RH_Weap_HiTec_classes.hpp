...
#include "RH_Weap_HiTec_structs.hpp"
...
// DynamicClass Weap_HiTec.Weap_HiTec_C
// 0x0040 (0x0FD0 - 0x0F90)
class AWeap_HiTec_C : public AShooterWeapon
{
public:
	...
	{
		static auto ptr = UObject::FindClass("DynamicClass Weap_HiTec.Weap_HiTec_C");
		return ptr;
	}
