...
#include "RH_WeaponPickup_dragunov_structs.hpp"
...
// DynamicClass WeaponPickup_dragunov.WeaponPickup_dragunov_C
// 0x0018 (0x0450 - 0x0438)
class AWeaponPickup_dragunov_C : public AShooterWeaponPickup
{
public:
	...
	{
		static auto ptr = UObject::FindClass("DynamicClass WeaponPickup_dragunov.WeaponPickup_dragunov_C");
		return ptr;
	}
