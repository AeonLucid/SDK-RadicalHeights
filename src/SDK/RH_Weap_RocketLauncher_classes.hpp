...
#include "RH_Weap_RocketLauncher_structs.hpp"
...
// DynamicClass Weap_RocketLauncher.Weap_RocketLauncher_C
// 0x0040 (0x0FD0 - 0x0F90)
class AWeap_RocketLauncher_C : public AShooterWeapon
{
public:
	...
	{
		static auto ptr = UObject::FindClass("DynamicClass Weap_RocketLauncher.Weap_RocketLauncher_C");
		return ptr;
	}
