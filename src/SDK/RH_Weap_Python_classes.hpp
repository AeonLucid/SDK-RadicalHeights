...
#include "RH_Weap_Python_structs.hpp"
...
// DynamicClass Weap_Python.Weap_Python_C
// 0x0040 (0x0FD0 - 0x0F90)
class AWeap_Python_C : public AShooterWeapon
{
public:
	...
	{
		static auto ptr = UObject::FindClass("DynamicClass Weap_Python.Weap_Python_C");
		return ptr;
	}
