...
{
public:
	struct FStickerUVTransforms                        StickerUvTransformInformation;                            // 0x0FA0(0x0020) (Edit, BlueprintVisible, DisableEditOnInstance)
	TArray<class USkeletalMeshComponent*>              CallFunc_GetComponentsByClass_ReturnValue;                // 0x0FC0(0x0010) (ExportObject, ZeroConstructor, Transient, DuplicateTransient)
	...
	TArray<int>                                        K2Node_MakeArray_Array;                                   // 0x0FD8(0x0010) (ZeroConstructor, Transient, DuplicateTransient)
	unsigned char                                      UnknownData01[0x8];                                       // 0x0FE8(0x0008) MISSED OFFSET
