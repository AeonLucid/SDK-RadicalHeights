...
#include "RH_PrizePickup_TV_structs.hpp"
...
// DynamicClass PrizePickup_TV.PrizePickup_TV_C
// 0x0028 (0x0408 - 0x03E0)
class APrizePickup_TV_C : public AShooterPickup_Cash
{
public:
	...
	{
		static auto ptr = UObject::FindClass("DynamicClass PrizePickup_TV.PrizePickup_TV_C");
		return ptr;
	}
