...
#include "RH_Weap_ConfettiBomb_structs.hpp"
...
// DynamicClass Weap_ConfettiBomb.Weap_ConfettiBomb_C
// 0x0040 (0x1000 - 0x0FC0)
class AWeap_ConfettiBomb_C : public AShooterWeapon
{
public:
	...
	{
		static auto ptr = UObject::FindClass("DynamicClass Weap_ConfettiBomb.Weap_ConfettiBomb_C");
		return ptr;
	}
