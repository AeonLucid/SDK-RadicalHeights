...
#include "RH_WeaponPickup_RocketLauncher_structs.hpp"
...
// DynamicClass WeaponPickup_RocketLauncher.WeaponPickup_RocketLauncher_C
// 0x0018 (0x0458 - 0x0440)
class AWeaponPickup_RocketLauncher_C : public AShooterWeaponPickup
{
public:
	...
	{
		static auto ptr = UObject::FindClass("DynamicClass WeaponPickup_RocketLauncher.WeaponPickup_RocketLauncher_C");
		return ptr;
	}
