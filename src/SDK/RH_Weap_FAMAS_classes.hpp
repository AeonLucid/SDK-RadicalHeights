...
#include "RH_Weap_FAMAS_structs.hpp"
...
// DynamicClass Weap_FAMAS.Weap_FAMAS_C
// 0x0040 (0x0FD0 - 0x0F90)
class AWeap_FAMAS_C : public AShooterWeapon
{
public:
	...
	{
		static auto ptr = UObject::FindClass("DynamicClass Weap_FAMAS.Weap_FAMAS_C");
		return ptr;
	}
