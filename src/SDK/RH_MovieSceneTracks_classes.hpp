...
#include "RH_MovieSceneTracks_structs.hpp"
...
public:
	...
	struct FName                                       AttachComponentName;                                      // 0x0058(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bConstrainTx : 1;                                         // 0x0060(0x0001) (Edit)
	unsigned char                                      bConstrainTy : 1;                                         // 0x0060(0x0001) (Edit)
	unsigned char                                      bConstrainTz : 1;                                         // 0x0060(0x0001) (Edit)
	unsigned char                                      bConstrainRx : 1;                                         // 0x0060(0x0001) (Edit)
	unsigned char                                      bConstrainRy : 1;                                         // 0x0060(0x0001) (Edit)
	unsigned char                                      bConstrainRz : 1;                                         // 0x0060(0x0001) (Edit)
...
public:
	...
	TArray<class FString>                              ActorGuidStrings;                                         // 0x00C8(0x0010) (ZeroConstructor)
...
public:
	...
	float                                              AudioVolume;                                              // 0x0050(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
...
public:
	unsigned char                                      UnknownData00[0x8];                                       // 0x0040(0x0008) MISSED OFFSET
	bool                                               DefaultValue;                                             // 0x0048(0x0001) (ZeroConstructor, Deprecated, IsPlainOldData)
...
{
public:
	class UCameraAnim*                                 CameraAnim;                                               // 0x0040(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              PlayRate;                                                 // 0x0048(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              PlayScale;                                                // 0x004C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              BlendInTime;                                              // 0x0050(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              BlendOutTime;                                             // 0x0054(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bLooping;                                                 // 0x0058(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x1];                                       // 0x0059(0x0001) MISSED OFFSET
	TEnumAsByte<ECameraAnimPlaySpace>                  PlaySpace;                                                // 0x005A(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x1];                                       // 0x005B(0x0001) MISSED OFFSET
	struct FRotator                                    UserDefinedPlaySpace;                                     // 0x005C(0x000C) (Edit, ZeroConstructor, IsPlainOldData)
...
{
public:
	TArray<class UMovieSceneSection*>                  CameraAnimSections;                                       // 0x0028(0x0010) (ZeroConstructor)
...
public:
	...
	float                                              PlayScale;                                                // 0x0048(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<ECameraAnimPlaySpace>                  PlaySpace;                                                // 0x004C(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x004D(0x0003) MISSED OFFSET
	struct FRotator                                    UserDefinedPlaySpace;                                     // 0x0050(0x000C) (Edit, ZeroConstructor, IsPlainOldData)
...
{
public:
	TArray<class UMovieSceneSection*>                  CameraShakeSections;                                      // 0x0028(0x0010) (ZeroConstructor)
...
{
public:
	TEnumAsByte<ELevelVisibility>                      Visibility;                                               // 0x0040(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x7];                                       // 0x0041(0x0007) MISSED OFFSET
	TArray<struct FName>                               LevelNames;                                               // 0x0048(0x0010) (Edit, ZeroConstructor)
...
{
public:
	class UAnimSequence*                               AnimSequence;                                             // 0x0040(0x0008) (ZeroConstructor, Deprecated, IsPlainOldData)
	class UAnimSequenceBase*                           Animation;                                                // 0x0048(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              StartOffset;                                              // 0x0050(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              EndOffset;                                                // 0x0054(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              PlayRate;                                                 // 0x0058(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bReverse : 1;                                             // 0x005C(0x0001) (Edit)
...
public:
	...
	float                                              PrerollTime;                                              // 0x0048(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x004C(0x0004) MISSED OFFSET
	class UMovieSceneSequence*                         SubSequence;                                              // 0x0050(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	TLazyObjectPtr<class AActor>                       ActorToRecord;                                            // 0x0058(0x001C) (Edit, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x0074(0x0004) MISSED OFFSET
	class FString                                      TargetSequenceName;                                       // 0x0078(0x0010) (Edit, ZeroConstructor)
	struct FDirectoryPath                              TargetPathToRecordTo;                                     // 0x0088(0x0010) (Edit)
