...
#include "RH_WeaponPickup_fal_structs.hpp"
...
// DynamicClass WeaponPickup_fal.WeaponPickup_fal_C
// 0x0018 (0x0458 - 0x0440)
class AWeaponPickup_fal_C : public AShooterWeaponPickup
{
public:
	...
	{
		static auto ptr = UObject::FindClass("DynamicClass WeaponPickup_fal.WeaponPickup_fal_C");
		return ptr;
	}
