...
#include "RH_Weap_PPK_structs.hpp"
...
// DynamicClass Weap_PPK.Weap_PPK_C
// 0x0040 (0x0FD0 - 0x0F90)
class AWeap_PPK_C : public AShooterWeapon
{
public:
	...
	{
		static auto ptr = UObject::FindClass("DynamicClass Weap_PPK.Weap_PPK_C");
		return ptr;
	}
