...
{
public:
	struct FButtonStyle                                ButtonStyle;                                              // 0x0030(0x02B0) (Edit, BlueprintVisible)
...
{
public:
	struct FComboBoxStyle                              ComboBoxStyle;                                            // 0x0030(0x0440) (Edit)
...
{
public:
	struct FComboButtonStyle                           ComboButtonStyle;                                         // 0x0030(0x03F0) (Edit)
...
{
public:
	struct FProgressBarStyle                           ProgressBarStyle;                                         // 0x0030(0x01C0) (Edit, BlueprintVisible)
...
{
public:
	struct FScrollBarStyle                             ScrollBarStyle;                                           // 0x0030(0x0520) (Edit)
...
{
public:
	struct FScrollBoxStyle                             ScrollBoxStyle;                                           // 0x0030(0x0250) (Edit)
...
{
public:
	struct FSpinBoxStyle                               SpinBoxStyle;                                             // 0x0030(0x0320) (Edit)
...
{
public:
	struct FTextBlockStyle                             TextBlockStyle;                                           // 0x0030(0x0150) (Edit)
