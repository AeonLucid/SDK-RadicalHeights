...
// Function UMG.UserWidget.GetViewportScale
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// float                          ReturnValue                    (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)

float UUserWidget::GetViewportScale()
{
	static auto fn = UObject::FindObject<UFunction>("Function UMG.UserWidget.GetViewportScale");

	UUserWidget_GetViewportScale_Params params;
...
// Function UMG.UserWidget.GetOwningHUD
// (Final, Native, Public, BlueprintCallable, BlueprintPure, Const)
// Parameters:
// class AHUD*                    ReturnValue                    (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)

class AHUD* UUserWidget::GetOwningHUD()
{
	static auto fn = UObject::FindObject<UFunction>("Function UMG.UserWidget.GetOwningHUD");

	UUserWidget_GetOwningHUD_Params params;
...
// Function UMG.WidgetComponent.MarkAsDirty
// (Final, Native, Public, BlueprintCallable)

void UWidgetComponent::MarkAsDirty()
{
	static auto fn = UObject::FindObject<UFunction>("Function UMG.WidgetComponent.MarkAsDirty");

	UWidgetComponent_MarkAsDirty_Params params;
...
// TEnumAsByte<EMouseLockMode>    InMouseLockMode                (Parm, ZeroConstructor, IsPlainOldData)
