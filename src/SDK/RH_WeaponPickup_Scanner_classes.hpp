...
#include "RH_WeaponPickup_Scanner_structs.hpp"
...
// DynamicClass WeaponPickup_Scanner.WeaponPickup_Scanner_C
// 0x0018 (0x0458 - 0x0440)
class AWeaponPickup_Scanner_C : public AShooterWeaponPickup
{
public:
	...
	{
		static auto ptr = UObject::FindClass("DynamicClass WeaponPickup_Scanner.WeaponPickup_Scanner_C");
		return ptr;
	}
