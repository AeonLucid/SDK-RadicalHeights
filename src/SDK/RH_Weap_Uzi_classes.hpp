...
#include "RH_Weap_Uzi_structs.hpp"
...
// DynamicClass Weap_Uzi.Weap_Uzi_C
// 0x0040 (0x0FD0 - 0x0F90)
class AWeap_Uzi_C : public AShooterWeapon
{
public:
	...
	{
		static auto ptr = UObject::FindClass("DynamicClass Weap_Uzi.Weap_Uzi_C");
		return ptr;
	}
