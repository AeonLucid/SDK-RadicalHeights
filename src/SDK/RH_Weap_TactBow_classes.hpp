...
#include "RH_Weap_TactBow_structs.hpp"
...
// DynamicClass Weap_TactBow.Weap_TactBow_C
// 0x0040 (0x1000 - 0x0FC0)
class AWeap_TactBow_C : public AShooterWeapon
{
public:
	...
	{
		static auto ptr = UObject::FindClass("DynamicClass Weap_TactBow.Weap_TactBow_C");
		return ptr;
	}
