...
#include "RH_Weap_SteyrAug_structs.hpp"
...
// DynamicClass Weap_SteyrAug.Weap_SteyrAUG_C
// 0x0040 (0x0FD0 - 0x0F90)
class AWeap_SteyrAUG_C : public AShooterWeapon
{
public:
	...
	{
		static auto ptr = UObject::FindClass("DynamicClass Weap_SteyrAug.Weap_SteyrAUG_C");
		return ptr;
	}
