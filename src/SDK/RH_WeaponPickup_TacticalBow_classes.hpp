...
#include "RH_WeaponPickup_TacticalBow_structs.hpp"
...
// DynamicClass WeaponPickup_TacticalBow.WeaponPickup_TacticalBow_C
// 0x0018 (0x0450 - 0x0438)
class AWeaponPickup_TacticalBow_C : public AShooterWeaponPickup
{
public:
	...
	{
		static auto ptr = UObject::FindClass("DynamicClass WeaponPickup_TacticalBow.WeaponPickup_TacticalBow_C");
		return ptr;
	}
