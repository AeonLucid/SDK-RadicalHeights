...
#include "RH_PrizePickup_Walkman_structs.hpp"
...
// DynamicClass PrizePickup_Walkman.PrizePickup_Walkman_C
// 0x0028 (0x0408 - 0x03E0)
class APrizePickup_Walkman_C : public AShooterPickup_Cash
{
public:
	...
	{
		static auto ptr = UObject::FindClass("DynamicClass PrizePickup_Walkman.PrizePickup_Walkman_C");
		return ptr;
	}
