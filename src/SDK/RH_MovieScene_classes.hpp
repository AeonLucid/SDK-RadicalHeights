...
#include "RH_MovieScene_structs.hpp"
...
public:
	...
	class UMovieSceneTrack*                            CameraCutTrack;                                           // 0x0068(0x0008) (ZeroConstructor, IsPlainOldData)
	struct FFloatRange                                 SelectionRange;                                           // 0x0070(0x0010) (ZeroConstructor, IsPlainOldData)
	struct FFloatRange                                 PlaybackRange;                                            // 0x0080(0x0010) (ZeroConstructor, IsPlainOldData)
	bool                                               bForceFixedFrameIntervalPlayback;                         // 0x0090(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0091(0x0003) MISSED OFFSET
	float                                              FixedFrameInterval;                                       // 0x0094(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              InTime;                                                   // 0x0098(0x0004) (ZeroConstructor, Deprecated, IsPlainOldData)
	float                                              OutTime;                                                  // 0x009C(0x0004) (ZeroConstructor, Deprecated, IsPlainOldData)
	float                                              StartTime;                                                // 0x00A0(0x0004) (ZeroConstructor, Deprecated, IsPlainOldData)
	float                                              EndTime;                                                  // 0x00A4(0x0004) (ZeroConstructor, Deprecated, IsPlainOldData)
