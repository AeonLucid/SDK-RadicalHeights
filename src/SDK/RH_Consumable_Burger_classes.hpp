...
#include "RH_Consumable_Burger_structs.hpp"
...
// DynamicClass Consumable_Burger.Consumable_Burger_C
// 0x0040 (0x1000 - 0x0FC0)
class AConsumable_Burger_C : public AShooterWeapon
{
public:
	...
	{
		static auto ptr = UObject::FindClass("DynamicClass Consumable_Burger.Consumable_Burger_C");
		return ptr;
	}
