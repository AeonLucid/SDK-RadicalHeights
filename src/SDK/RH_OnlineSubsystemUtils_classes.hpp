...
#include "RH_OnlineSubsystemUtils_structs.hpp"
...
// 0x0020 (0x33728 - 0x33708)
class UIpConnection : public UNetConnection
{
public:
	unsigned char                                      UnknownData00[0x20];                                      // 0x33708(0x0020) MISSED OFFSET
...
{
public:
	unsigned char                                      LogPortUnreach : 1;                                       // 0x0370(0x0001) (Config)
	unsigned char                                      AllowPlayerPortUnreach : 1;                               // 0x0370(0x0001) (Config)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0371(0x0003) MISSED OFFSET
	uint32_t                                           MaxPortCountToTry;                                        // 0x0374(0x0004) (ZeroConstructor, Config, IsPlainOldData)
...
public:
	...
	TEnumAsByte<EBeaconConnectionState>                ConnectionState;                                          // 0x03D0(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x5F];                                      // 0x03D1(0x005F) MISSED OFFSET
...
{
public:
	class FString                                      BeaconTypeName;                                           // 0x0398(0x0010) (ZeroConstructor, Transient)
