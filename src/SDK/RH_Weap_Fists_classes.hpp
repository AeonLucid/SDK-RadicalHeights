...
#include "RH_Weap_Fists_structs.hpp"
...
// DynamicClass Weap_Fists.Weap_Fists_C
// 0x0040 (0x1000 - 0x0FC0)
class AWeap_Fists_C : public AShooterWeapon
{
public:
	...
	{
		static auto ptr = UObject::FindClass("DynamicClass Weap_Fists.Weap_Fists_C");
		return ptr;
	}
