...
#include "RH_Weap_SawedOff_structs.hpp"
...
// DynamicClass Weap_SawedOff.Weap_SawedOff_C
// 0x0050 (0x1010 - 0x0FC0)
class AWeap_SawedOff_C : public AShooterWeapon_Shotgun
{
public:
	...
	{
		static auto ptr = UObject::FindClass("DynamicClass Weap_SawedOff.Weap_SawedOff_C");
		return ptr;
	}
